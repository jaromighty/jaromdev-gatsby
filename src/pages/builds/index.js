        ...
        <>
            ...
            <MainLayout>
                <div className="p-8">
                    ...
                    <p className="mt-6 text-gray-600 max-w-xl">Each webpage listed here are based on web designs I found. I tried to keep to the original design as much as possible. In some instances, I took a small number of creative liberties.</p>
                    <div className="mt-16">
                            ...
                            <Link to="travel-landing-page-oww" className="block group">
                                <figure>
                                    <div className="relative rounded-3xl overflow-hidden transition transform duration-150 ease-in-out">
                                        <img src={jalanin} alt="Jalanin" className="w-full h-auto" />
