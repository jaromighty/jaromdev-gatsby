...
import building from "../../images/hernan-lucio-gJFvHkUHdSI-unsplash.jpg";
import {
    AnnotationIcon,
    ChatAlt2Icon,
    InboxIcon,
...
export default function DineryLandingPage() {
    return (
        <>
            <SEO title="Dinery Digital Bank Landing Page" />
                            ...
                            <div className="relative sm:rounded-3xl sm:overflow-hidden">
                                <div className="absolute inset-0">
                                    <img
                                        ...
                                        src={building}
                                        alt="colorful building corner"
                                    />
                                    <div className="absolute inset-0 bg-gray-100 mix-blend-multiply" />
                                </div>
                                <div className="relative p-4 sm:p-6 lg:p-8">
                                    <header>
                                        <Popover className="relative bg-white rounded-lg bg-opacity-80">
                                            <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
                                                ...
                                                <div className="-mr-2 -my-2 md:hidden">
                                                    <Popover.Button className="bg-white bg-opacity-80 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                                    ...
                                    <h2 className="mt-4 max-w-xs text-3xl leading-normal font-semibold text-gray-900 md:text-5xl">
