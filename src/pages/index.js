...
import jarom from "../images/homepage-short.png"
                ...
                <div className="p-8">
                    <div className="bg-gray-200 rounded-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
                        ...
                        <div className="hidden md:block -mt-6 md:-mt-36 lg:mt-0 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
                            <img className="transform translate-x-6 translate-y-6 lg:translate-x-0 xl:-translate-x-28 xl:translate-y-12 rounded-md object-contain object-right-top" src={jarom} alt="Jarom Rial" />
                        </div>
                    </div>
                </div>
            </MainLayout>
